...
ROUTES = [
    ...
    {"id": "route_rfp_flavin_photo", "name": "RFP + flavin photochemical (light-history) route", "route_class": "RFP_flavin_photochemical", "max_claim_level": "measurement_triage", "required_cofactors": ["FMN", "intrinsic chromophore"]},
